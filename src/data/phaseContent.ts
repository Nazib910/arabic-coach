...
export const phaseContent: Record<string, PhaseContent> = {
  ...
  "case-awareness": {
    vocabulary: ["ـُ (رفع)","ـَ (نصب)","ـِ (جر)","الفاعل","المفعول","مضاف إليه","مثنى","جمع سالم","رجلان","معلّمون","مسلمات","حرف جر"],
    models: ["ذهبَ الطالبُ إلى المدرسةِ.","رأيتُ الطالبَ في الصفِّ.","مررتُ بالطالبِ أمامَ البابِ.","جاء المعلّمانِ والمعلّمونَ."],
    grammarPoints: [
  ...
  "media-foundations": {
    vocabulary: ["عنوان","خبر","تقرير","الطقس","درجة الحرارة","اقتصاد","سياسة","مليون","مليار","التاريخ","المصدر","حسب"],
    models: ["حسب التقريرِ، الطقسُ حارٌّ اليومَ.","أعلنت الحكومةُ خبراً جديداً.","بلغ العددُ مليونَ نسمةٍ.","نُشِر المقالُ في التاريخِ نفسِه."],
    grammarPoints: [
  ...
  "verb-system-1": {
    vocabulary: ["علّم (II)","درّس (II)","شاهد (III)","ساعد (III)","أرسل (IV)","أخرج (IV)","تعليم","مساعدة","إرسال","جذر","وزن","مصدر"],
    models: ["علّمَ الأستاذُ الطلابَ العربيةَ.","ساعدتُ صديقي في العملِ.","أرسلتُ رسالةً إلى أختي.","التعليمُ مصدرُ الفعلِ علّم."],
    grammarPoints: [
  ...
  opinions: {
    vocabulary: ["أفضل","أهم","أكثر","لأنّ","لذلك","مع أنّ","أوافق","لا أوافق","في رأيي","بالإضافة","من ناحية","النتيجة"],
    models: ["في رأيي، القراءةُ أهمُّ من مشاهدةِ التلفاز.","أوافقُ لأنّ العربيةَ مفيدةٌ.","مع أنّها صعبةٌ، لكنها ممتعةٌ.","لذلك أنصحُ بالدراسةِ اليوميةِ."],
    grammarPoints: [
  ...
  consolidation: {
    vocabulary: ["مراجعة","تكرار","طلاقة","مشروع","تسجيل","نطق","تحسين","هدف","تقييم","نقطة ضعف","نقطة قوة","خطة"],
    models: ["أراجعُ ما تعلّمتُه كلَّ أسبوعٍ.","سجّلتُ نفسي وأنا أتكلّمُ.","نقطةُ ضعفي هي النطقُ.","خطّتي أن أحسّنَ الطلاقةَ."],
    grammarPoints: [
  ...
  "verb-system-2": {
    vocabulary: ["تعلّم (V)","تعاون (VI)","انكسر (VII)","اجتمع (VIII)","استخدم (X)","فاعل","مفعول","اسم الفاعل","اسم المفعول","معتلّ","أجوف","ناقص"],
    models: ["تعلّمتُ اللغةَ بنفسي.","تعاونَ الطلابُ في المشروعِ.","اجتمعَ الفريقُ صباحاً.","المعلّمُ هو الفاعلُ، والدرسُ هو المفعولُ."],
    grammarPoints: [
  ...
  "complex-grammar": {
    vocabulary: ["كان","أصبح","ليس","إنّ","أنّ","لكنّ","إذا","لو","إلّا","التوكيد","الشرط","الجواب"],
    models: ["كان الطقسُ بارداً أمسِ.","إنّ العلمَ نورٌ.","إذا درستَ، نجحتَ.","لم يحضرْ أحدٌ إلّا خالداً."],
    grammarPoints: [
  ...
  "academic-literacy": {
    vocabulary: ["تعريف","تصنيف","سبب","نتيجة","مقدمة","خاتمة","فقرة","حجّة","مثال","بمعنى","يتكوّن من","يشير إلى"],
    models: ["يتكوّنُ الموضوعُ من ثلاثةِ أقسامٍ.","التعريفُ هو أن نوضّحَ المعنى.","نتيجةً لذلك، ارتفعَ العددُ.","تشيرُ الدراسةُ إلى أهميةِ القراءةِ."],
    grammarPoints: [
  ...
  "authentic-listening": {
    vocabulary: ["مقابلة","مذيع","ضيف","لقاء","برنامج","بثّ","مباشر","تصريح","استنتاج","فكرة رئيسية","تفصيل","ملاحظة"],
    models: ["أجرى المذيعُ مقابلةً مع الضيفِ.","في البثِّ المباشرِ، ناقشوا الاقتصادَ.","الفكرةُ الرئيسيةُ هي التعليمُ.","استنتجتُ ذلك من التفاصيلِ."],
    grammarPoints: [
  ...
  "literature-bridge": {
    vocabulary: ["قصة","بطل","حدث","صورة","رمز","أسلوب","مشهد","عاطفة","لغة أدبية","معنى خفي","حوار","سرد"],
    models: ["بدأت القصةُ بمشهدٍ هادئٍ.","استخدم الكاتبُ صورةً جميلةً.","شعرَ البطلُ بالحزنِ.","في هذا الرمزِ معنىً خفيٌّ."],
    grammarPoints: [
  ...
  "formal-communication": {
    vocabulary: ["عرض تقديمي","بريد إلكتروني","تقرير","ملخّص","المحترم","تحية طيبة","وبعد","نأمل","مرفق","بخصوص","نتشرّف","تفضّلوا"],
    models: ["تحيةً طيبةً وبعد،","نأملُ التعاونَ في هذا المشروعِ.","مرفقٌ التقريرُ للمراجعةِ.","سأقدّمُ عرضاً عن التعليمِ."],
    grammarPoints: [
  ...
  "advanced-syntax": {
    vocabulary: ["المبني للمجهول","الحال","المفعول المطلق","التمييز","الترابط","نائب الفاعل","بينما","حيث","إذ","قد","ضمير الفصل","التقديم"],
    models: ["كُتِبَ المقالُ بعنايةٍ.","خرجَ الطالبُ مسرعاً.","فرِحَ فرحاً شديداً.","ازدادَ الطلابُ عدداً."],
    grammarPoints: [
  ...
  argumentation: {
    vocabulary: ["ادّعاء","دليل","حجّة مضادة","على الرغم","قد يُقال","الأرجح","بناءً على","علاوةً","ختاماً","وجهة نظر","إقناع","ترجيح"],
    models: ["أرى أنّ التعليمَ حقٌّ للجميعِ.","الدليلُ على ذلك واضحٌ.","قد يُقالُ عكسُ ذلك، لكن…","بناءً على ما سبق، أرجّحُ هذا الرأيَ."],
    grammarPoints: [
  ...
  "independent-comprehension": {
    vocabulary: ["مقال","محاضرة","بودكاست","مصطلح","مرادف","ضدّ","سياق","استقلالية","مصدر موثوق","تصفّح","تعمّق","استخلاص"],
    models: ["قرأتُ مقالاً كاملاً دون قاموسٍ.","استمعتُ إلى محاضرةٍ وفهمتُ الفكرةَ.","خمّنتُ المصطلحَ من السياقِ.","أعتمدُ على مصادرَ موثوقةٍ."],
    grammarPoints: [
  ...
  capstone: {
    vocabulary: ["حصيلة","مراجعة نهائية","اختبار","إنجاز","تطوّر","استمرارية","هدف بعيد","تقييم ذاتي","ملف الأعمال","خلاصة","التزام","المستوى"],
    models: ["راجعتُ ملفَّ أعمالي كاملاً.","تطوّرتْ مهاراتي كثيراً هذا العامَ.","خطّتي القادمةُ هي بلوغُ مستوى B2.","سأستمرُّ في الدراسةِ اليوميةِ."],
    grammarPoints: [
